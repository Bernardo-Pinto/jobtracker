    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [2 /*return*/, db.all('SELECT * FROM Applications')];
            }
        });
    });
}
// Add a new Application
function addApplication(company, title, link, applied_on, salary_min, salary_max, status, last_step, last_updated, notes) {
    return __awaiter(this, void 0, void 0, function () {
        var db;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, db.run("INSERT INTO Applications \n        (company, title, link, applied_on, salary_min, salary_max, status, last_step, last_updated, notes) \n        VALUES (?,?,?,?,?,?,?,?,?)", [company, title, link, applied_on, salary_min, salary_max, status, last_step, last_updated, notes])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, db.run("UPDATE applications SET\n            company = ?,\n            title = ?,\n            link = ?,\n            applied_on = ?,\n            salary_min = ?,\n            salary_max = ?,\n            status = ?,\n            last_step = ?,\n            last_updated = ?,\n            notes = ?\n        WHERE id = ?", [
                            application.company,
                            application.title,
                            application.link,
